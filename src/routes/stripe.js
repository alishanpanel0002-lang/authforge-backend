...
const PLANS = {
  pro: { price_id: 'price_1TCChiGg2QoPbQIFz9hAH6pP', name: 'Pro', limit_apps: 10, limit_users: 10000 },
  business: { price_id: 'price_1TCCiSGg2QoPbQIFMe5lVNta', name: 'Business', limit_apps: -1, limit_users: -1 }
};
